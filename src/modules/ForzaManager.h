...
// --- NFS Unbound Dashboard: animation & layout ---
#define FORZA_RPM_JITTER_RANGE 2
#define FORZA_RED_ZONE_FLICKER_MS 40
#define FORZA_GEAR_CHANGE_VIBRATE_RANGE 2
#define FORZA_SPEED_BRAKE_DROP_PX 3
#define FORZA_STATUS_FLICKER_HZ 2
#define FORZA_EMA_RPM 0.35f
#define FORZA_EMA_SPEED 0.28f
#define FORZA_EMA_GEAR 0.42f
#define FORZA_JITTER_PROBABILITY 0.15f
#define FORZA_GEAR_CHANGE_MS 200
#define FORZA_RED_ZONE_RPM_PCT 0.85f
#define RPM_BAR_HEIGHT 18
#define FORZA_GEAR_BOX_SIZE 36
#define FORZA_TIRE_CELL_SIZE 16
#define FORZA_FUEL_BAR_WIDTH 35
#define FORZA_STATUS_LINE_Y 58
#define FORZA_SCANLINE_SPACING 3
#define FORZA_GRID_SPACING 8
#define FORZA_BORDER_NOISE_PCT 3
