...
/*
 * NOCTURNE_OS тАФ BLE Phantom Spammer: rotate Apple / Google / Samsung payloads.
...
// Apple AirPods Pro Gen2 тАФ manufacturer data: 0x004C (LE) + 27 bytes.
...
// Google Fast Pair тАФ Service Data 0xFE2C, 3-byte Model ID (known to trigger).
...
// Samsung (SmartTag / Galaxy Buds style) тАФ manufacturer 0x0075, extended.
...
// Windows (Surface / accessories) тАФ manufacturer 0x0006.
...
void BleManager::setPayload(int index) {
  ...
  case 1: // Google Fast Pair тАФ Service Data UUID 0xFE2C, 3-byte Model ID
  {
...
void BleManager::begin() {
  // ╨Я╤А╨╛╨▓╨╡╤А╨║╨░ ╤Б╨╛╤Б╤В╨╛╤П╨╜╨╕╤П WiFi ╨┐╨╡╤А╨╡╨┤ ╨╖╨░╨┐╤Г╤Б╨║╨╛╨╝ BLE (╨▓╨╜╨╡ ╤Г╤Б╨╗╨╛╨▓╨╜╨╛╨╣ ╨║╨╛╨╝╨┐╨╕╨╗╤П╤Ж╨╕╨╕)
