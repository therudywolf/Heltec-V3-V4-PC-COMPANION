/*
 * NOCTURNE_OS тАФ ForzaManager: UDP listener for Forza Horizon 4/5 and Motorsport
...
// Layout (128x64) тАФ F1 style: thin RPM bar | Gear left (huge), Speed right | Shift bottom
