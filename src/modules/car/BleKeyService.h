...
class BleKeyService {
 public:
  ...
  /** Update status characteristic (READ/NOTIFY). Call from BmwManager::tick(). lastMflAction: 0=none, 1=next, 2=prev, 3=play_pause, 4=vol_up, 5=vol_down. */
 ...
 private:
  ...
  static const size_t kStatusPacketLen = 10;
