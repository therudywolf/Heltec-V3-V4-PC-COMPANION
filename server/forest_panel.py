...
#   windows_exporter job="integrations/windows_exporter" instance="WORKSTATION"
DEFAULT_NODES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "cpu": '100-(avg(rate(windows_cpu_time_total{mode="idle",instance="WORKSTATION"}[5m]))*100)',
        "ram": '100*(1-windows_os_physical_memory_free_bytes{instance="WORKSTATION"}/windows_cs_physical_memory_bytes{instance="WORKSTATION"})',
        "disk": '100*(1-windows_logical_disk_free_bytes{instance="WORKSTATION",volume="C:"}/windows_logical_disk_size_bytes{instance="WORKSTATION",volume="C:"})',
    },
]
