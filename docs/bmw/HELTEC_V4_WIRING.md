...
Один документ для сборки подключения «от платы до машины»: Heltec WiFi LoRa 32 V4 → трансивер I-Bus → автомобиль BMW (E39/E46/E38/E53 и совместимые).
...
После проверки — питание платы, вход в режим BMW Assistant (меню → BMW → долгое нажатие). При работе шины на экране будет «IBUS OK»; для отладки пакетов — `NOCT_IBUS_MONITOR_VERBOSE 1` в config.h и монитор порта 115200 бод.
