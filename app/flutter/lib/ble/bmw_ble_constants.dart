...
class BmwControlCmd {
  ...
  static const int mflNext = 30;
  static const int mflPrev = 31;
  static const int startLightShow = 0x80;
  static const int stopLightShow = 0x81;
  // Extended commands (M-Power Flex / Instincts)
  static const int strobeToggle = 0x90;
  static const int sensoryDarkModeOn = 0x91;
  static const int sensoryDarkModeOff = 0x92;
  static const int comfortBlinkOn = 0x93;
  static const int comfortBlinkOff = 0x94;
  static const int panicMode = 0x95;
  static const int mirrorFoldOn = 0x96;
  static const int mirrorFoldOff = 0x97;
  /// Next cluster text write is stored as startup greeting on ESP32.
  static const int startupGreeting = 0x98;
}
